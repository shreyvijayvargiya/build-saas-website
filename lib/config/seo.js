...
export const SEO_CONFIG = {
	...
	// Landing Page
	"/landing-page": {
		title: "SAAS Starter - Build Your SaaS 10x Faster",
		description:
			"Complete SaaS boilerplate with authentication, payments, admin panel, and more. Get started in minutes, not months. One-time payment, lifetime access.",
		keywords:
			"saas, boilerplate, nextjs, firebase, stripe, starter, saas template, saas boilerplate",
		ogImage: "https://b4fcijccdw.ufs.sh/f/mVUSE925dTRYo9pGrkQGL8ds7z9t2vD05fIReEJKO3Cy1jZP",
		ogType: "website",
	},
