...
const DOC_SECTIONS = [
	...
	{ id: "apis", title: "APIs", file: "apis.md", icon: Code2 },
	{ id: "database", title: "Database", file: "database.md", icon: Database },
	{ id: "emailing", title: "Emailing", file: "emailing.md", icon: Mail },
	{
		id: "payments",
		title: "Payments",
		file: "payments.md",
	...
	{ id: "admin", title: "Admin", file: "admin.md", icon: Settings },
	{ id: "seo", title: "SEO", file: "seo.md", icon: Globe },
	{ id: "faq", title: "FAQ", file: null, icon: HelpCircle },
];
...
export default function DocsPage() {
	...
	return (
		<div className="min-h-screen bg-zinc-50 dark:bg-zinc-900 flex">
			{/* Sidebar */}
			<aside className="hidden md:flex w-64 bg-white dark:bg-zinc-800 border-r border-zinc-200 dark:border-zinc-700 flex-col h-screen sticky top-0 font-mono">
				<div className="flex justify-between p-4 border-b border-zinc-200 dark:border-zinc-700">
					...
					{/* Theme Toggle Button - Fixed Bottom */}
					<motion.button
					...
					>
						{isDark ? (
							<Sun className="w-3 h-3" onClick={toggleTheme} />
						) : (
							<Moon className="w-3 h-3" onClick={toggleTheme} />
						)}
					</motion.button>
				</div>
			...
			<main className="flex-1 flex flex-col relative">
				...
				<div className="flex-1 overflow-y-auto">
					<div
						className={`max-w-4xl mx-auto px-4 ${tableOfContents?.length > 0 && activeSection !== "faq" ? "lg:pr-80" : ""}`}
					>
										...
										components={{
											...
											code: ({
												...
												if (inline) {
													return (
														<code
															className="text-zinc-900 dark:text-zinc-100 px-1 py-0.5 rounded text-xs font-mono bg-zinc-100 dark:bg-zinc-800"
															{...props}
														>
															{children}
														</code>
					...
					{tableOfContents?.length > 0 && activeSection !== "faq" && (
						<aside className="hidden lg:block absolute right-0 top-0 w-64 h-full">
							<div className="border-l border-zinc-200 dark:border-zinc-700 pl-6 py-4 fixed top-0 bottom-0 overflow-y-auto hidescrollbar">
